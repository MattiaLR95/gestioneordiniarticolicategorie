...
public class CategoriaServiceImpl implements CategoriaService {
	...
	@Override
	public List<Categoria> TutteCategorieInOrdine(Ordine ordine) throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return categoriaDAO.allCategorieInOrdine(ordine);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		} finally {
	...
	@Override
	public List<String> tuttiCodiciDiCategorieDegliOrdiniEffettuatiNelMeseDi(Date dataDiRiferimento) throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return categoriaDAO.allCodiciDiCategorieDegliOrdiniEffettuatiNelMeseDi(dataDiRiferimento);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		} finally {
